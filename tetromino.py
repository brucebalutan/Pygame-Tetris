...
class Tetromino:
    ...
    def move(self, direction):
        ...
        new_block_positoins = [block.pos + move_direction for block in self.blocks]
        is_collide = self.is_collide(new_block_positoins)
        if not is_collide:
