...
class Text:
    ...
    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.595, WIN_H * 0.02),
                            ...
                            size=TILE_SIZE * 1.5, bgcolor='black')
        ...
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.67),
                            ...
                            size=TILE_SIZE * 1.4, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.60, WIN_H * 0.8),
                            text=f'{self.app.tetris.score}', fgcolor='white',
                            size=TILE_SIZE * 1.5)

# Tetris class that will be called in the main method
class Tetris:
    # Make the tetris class an instance of the app
    def __init__(self, app):
        self.app = app
    ...
    # Draw grid on the field to see the spaces
    def draw_grid(self):
        for x in range(FIELD_W):
